...
class QueriesControllerTest < ActionController::TestCase
  ...
  test "should create query" do
    assert_difference('Query.count') do
      post :create, query: { bussiness_plan_id: @query.bussiness_plan_id, entrepreneur_id: @query.entrepreneur_id, question: @query.question, status: @query.status }
    end
  ...
  test "should update query" do
    put :update, id: @query, query: { bussiness_plan_id: @query.bussiness_plan_id, entrepreneur_id: @query.entrepreneur_id, question: @query.question, status: @query.status }
    assert_redirected_to query_path(assigns(:query))
  end
