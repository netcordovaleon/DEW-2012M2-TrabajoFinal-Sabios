...
class SellsControllerTest < ActionController::TestCase
  ...
  test "should create sell" do
    assert_difference('Sell.count') do
      post :create, sell: { address: @sell.address, code: @sell.code, credir_car: @sell.credir_car, date: @sell.date }
    end
  ...
  test "should update sell" do
    put :update, id: @sell, sell: { address: @sell.address, code: @sell.code, credir_car: @sell.credir_car, date: @sell.date }
    assert_redirected_to sell_path(assigns(:sell))
  end
